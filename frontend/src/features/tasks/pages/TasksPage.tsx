          ...
          <tbody>
            {tasks.map((task) => (
              <TableRow key={task.id}>
                ...
                <TableCell>{task.stage_label || task.stage_key || '-'}</TableCell>
                <TableCell>
                  <Badge status={getStatusColor(task.status)}>
                    {task.status || '-'}
                  </Badge>
                </TableCell>
                <TableCell>{task.planned_date || '-'}</TableCell>
                <TableCell>{task.actual_date || task.done_at || '-'}</TableCell>
                <TableCell>{task.assigned_to || task.done_by || '-'}</TableCell>
              </TableRow>
            ))}
          </tbody>
        </Table>
